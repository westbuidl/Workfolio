        ...
        <div className="prose max-w-none mb-12">
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Contact us at <a href="mailto:privacy@cinthpay.com" className="text-blue-600 hover:underline">privacy@cinthpay.com</a> to exercise these rights.</li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>For privacy inquiries, email <a href="mailto:privacy@cinthpay.com" className="text-blue-600 hover:underline">privacy@cinthpay.com</a> or call +44 20 1234 5678.</li>
            </ul>
          </div>
        </div>
